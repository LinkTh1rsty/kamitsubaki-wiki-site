...
CDアルバム「観測」を除いては、スペシャルボックスαには、写真集「透明」(24P)、トーキー「御伽噺-第零幕-」(詩CD)、アクリルキーホルダー(PALOW ver.)、ポストカード(PALOW ver.)、ステッカーαセット(3枚)、丸バッジセットα(3枚)、kaf、カンザキイオリからのメッセージが封入されています。ボックスβには、「透明」、トーキー「御伽噺-第一幕-」、アクリルキーホルダー(shirone ver.)、ポストカード(shirone ver.)、ステッカーβセット(3枚)、丸バッジβ(3枚)、kaf、カンザキオリからのメッセージが入っています。
